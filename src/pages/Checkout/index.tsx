  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string()
        ...
        .required('O campo é obrigatório'),
      cpf: Yup.string()
        .min(14, "O campo precisa ter o modelo: '000.000.000-00'")
        .max(14, "O campo precisa ter o modelo: '000.000.000-00'"),
              ...
              <div className="margin-top">
                {payWithCard ? (
                  ...
                  <p>
                    ...
                    adquirido ocorrerá somente após aprovação do pagamento do
                    boleto.
                  </p>
                )}
              </div>
